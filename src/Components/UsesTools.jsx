    ...
    <div className='w-full'>
        <div className='text-black font-medium text-xl font-[Poppins] p-1 pt-7 pb-3 '>More Useful Tools</div>
         <div className='flex w-full -mx-3'>
            <div className='w-1/2 p-3 min-h-20'> 
              <div className='flex h-full bg-[#DFF7FF] shadow-sm rounded-2xl p-3 items-center '>
            ...
            <div className=' w-1/2 p-3 min-h-20'>
              <div className='flex h-full bg-[#FFDFDF] shadow-sm rounded-2xl p-3 items-center'>
